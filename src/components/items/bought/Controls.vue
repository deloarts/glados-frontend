...
<template>
  <div class="controls-base-scope">
    <div id="item-controls" class="controls-base-container">
      <ButtonItemCreate class="controls-base-element" text="New Item" v-on:click="onButtonNewItem"></ButtonItemCreate>
      <ButtonExcel class="controls-base-element" text="Import Excel" v-on:click="onButtonUploadExcel"></ButtonExcel>
      <ButtonExcel class="controls-base-element" text="Export Excel" v-on:click="onButtonDownloadExcel"></ButtonExcel>
      <ButtonEdit class="controls-base-element" text="Edit Item" v-on:click="onButtonEdit"></ButtonEdit>
      <ButtonCopy class="controls-base-element" text="Copy Item" v-on:click="onButtonCopy"></ButtonCopy>
      <ButtonDelete class="controls-base-element" text="Delete Item" v-on:click="onButtonDelete"></ButtonDelete>
    </div>
    <div id="filter-controls" class="controls-base-container">
      <ButtonFilterSave class="controls-base-element" text="Save Filter" v-on:click="saveFilter"></ButtonFilterSave>
      <ButtonFilterLoad class="controls-base-element" text="Load Filter" v-on:click="loadFilter"></ButtonFilterLoad>
      <ButtonFilterClear class="controls-base-element" text="Clear Filter" v-on:click="clearFilter"></ButtonFilterClear>

      <SelectControls class="controls-base-element" text="Limit" v-model:selection="filterStore.limit" :options="availableOptionsLimit"></SelectControls>
      <SelectControls class="controls-base-element" text="Sort By" v-model:selection="filterStore.sortBy" :options="availableOptionsOrderBy"></SelectControls>
      <SelectControls class="controls-base-element" text="Preset" v-model:selection="selectedOptionFilterPreset" :options="availableOptionsFilterPresets"></SelectControls>

      <DropDownTableView class="controls-base-element" text="Views" :hide-when-clicked="false">
        <div class="drop-down-toggle-item"><Toggle v-model="filterStore.ignoreDelivered"></Toggle><span class="drop-down-toggle-item-text">Ignore Delivered</span></div>
        <div class="drop-down-toggle-item"><Toggle v-model="filterStore.ignoreCanceled"></Toggle><span class="drop-down-toggle-item-text">Ignore Canceled</span></div>
        <div class="drop-down-toggle-item"><Toggle v-model="filterStore.ignoreLost"></Toggle><span class="drop-down-toggle-item-text">Ignore Lost</span></div>
        <div class="drop-down-toggle-item"><Toggle v-model="controlsStore.fixedHeight"></Toggle><span class="drop-down-toggle-item-text">Fixed Height</span></div>
        <div class="drop-down-toggle-item"><Toggle v-model="controlsStore.unclutter"></Toggle><span class="drop-down-toggle-item-text">Unclutter</span></div>
        <div class="drop-down-toggle-item"><Toggle v-model="controlsStore.requestView"></Toggle><span class="drop-down-toggle-item-text">Request View</span></div>
        <div class="drop-down-toggle-item"><Toggle v-model="controlsStore.changelog"></Toggle><span class="drop-down-toggle-item-text">Changelog</span></div>
        <div class="drop-down-toggle-item"><Toggle v-model="controlsStore.rainbow"></Toggle><span class="drop-down-toggle-item-text">Rainbow</span></div>
        <div class="drop-down-toggle-item"><Toggle v-model="controlsStore.textOnly"></Toggle><span class="drop-down-toggle-item-text">Text Only</span></div>
      </DropDownTableView>
    </div>
  </div>
