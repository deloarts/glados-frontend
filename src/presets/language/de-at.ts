...
export const deAT: Language = {
  ...
  notification: {
    ...
    warn: {
      ...
      passwordCannotBeEmpty: 'Das Passwort muss ausgefüllt sein',
  ...
  account: {
    banner: {
      ...
      patCreationWarning:
        'Beim Erstellen eines neuen Schlüssels wird der aktuelle Schlüssel ungültig. Speichere den neuen Schlüssel an einem sicheren Ort, du kannst ihn kein zweites Mail einsehen.',
      patInfo: 'Ablaufdatum des Tokens: ',
      rfidInfo: 'Zu deinem Konto ist ein RFID-Chip zugewiesen',
      userTimeInfo: 'Um die Zeitaufzeichnung zu nutzen musst du die Wochenarbeitszeit angeben',
    },
    button: {
      myAccount: 'Mein Konto',
      security: 'Sicherheit',
    ...
    permissions: {
      ...
      superUser: 'Super-User Konto',
      adminUser: 'Admin-User Konto',
      guestUser: 'Gastkonto',
      yourPermissionLevel: 'Dein Rechte-Level in Glados: ',
      yourPermissionProjects: 'Projekte',
      yourPermissionItems: 'Zukaufteile',
      yourPermissionUserTime: 'Zeitaufzeichnung',
      yourPermissionUsers: 'Benutzer',
      yourPermissionSettings: 'Einstellungen',
      readOwnProjects: 'Eigene Projekte lesen',
      readOtherProjects: 'Projekte anderer Benutzer lesen',
      createProjects: 'Projekte erstellen',
      editOwnProjects: 'Eigene Projekte bearbeiten',
      editOtherProjects: 'Projekte anderer Benutzer bearbeiten',
      assignOtherUserToProject: 'Einen anderen Benutzer einem Projekt zuweisen',
      deleteProjects: 'Projekte löschen',
      readOwnItems: 'Eigene Elemente lesen',
      readOtherItems: 'Elemente anderer Benutzer lesen',
      createItems: 'Elemente erstellen',
      editOwnItems: 'Eigene Elemente bearbeiten',
      editOtherItems: 'Elemente anderer Benutzer bearbeiten',
      editPlannedItems: 'Geplante Elemente bearbeiten',
      deleteOwnItems: 'Eigene Elemente löschen',
      deleteOtherItems: 'Elemente anderer Benutzer löschen',
      createUsers: 'Benutzer erstellen',
      editUsers: 'Benutzer bearbeiten',
      deleteUsers: 'Benutzer löschen',
      readOwnUserTime: 'Eigenen Zeiteintrag lesen',
      readOtherUserTime: 'Zeiteintrag eines anderen Benutzers lesen',
      createUserTime: 'Einen Zeiteintrag erstellen',
      editOwnUserTime: 'Eigenen Zeiteintrag bearbeiten',
      editOtherUserTime: 'Zeiteintrag eines anderen Benutzers bearbeiten',
      deleteOwnUserTime: 'Eigenen Zeiteintrag löschen',
