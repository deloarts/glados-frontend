...
export const enGB: Language = {
  ...
  notification: {
    ...
    warn: {
      ...
      passwordCannotBeEmpty: 'The password field cannot be empty',
  ...
  account: {
    banner: {
      ...
      patCreationWarning:
        "Creating a new token renders the current token invalid. Store your newly created token somewhere save, you won't be able to see it again.",
      patInfo: 'Token expiration date: ',
      rfidInfo: 'There is a RFID tag linked to this account',
      userTimeInfo: 'In order to use the time logger, you need to provide the weekly working time',
    },
    button: {
      myAccount: 'My Account',
      security: 'Security',
    ...
    input: {
      ...
      autoBreakByDay: 'Auto break by day',
      autoBreakMon: 'Monday',
      autoBreakTue: 'Tuesday',
      autoBreakWed: 'Wednesday',
      autoBreakThu: 'Thursday',
      autoBreakFri: 'Friday',
      autoBreakSat: 'Saturday',
      autoBreakSun: 'Sunday',
    },
    permissions: {
      ...
      yourPermissionLevel: 'Your permission level in Glados: ',
      yourPermissionProjects: 'Projects',
      yourPermissionItems: 'Items',
      yourPermissionUserTime: 'User Time',
      yourPermissionUsers: 'Users',
      yourPermissionSettings: 'Settings',
      readOwnProjects: 'Read own projects',
      readOtherProjects: "Read other user's projects",
      createProjects: 'Create projects',
      editOwnProjects: 'Edit own projects',
      editOtherProjects: "Edit other user's projects",
      assignOtherUserToProject: 'Assign another user to a project',
      deleteProjects: 'Delete projects',
      readOwnItems: 'Read own items',
      readOtherItems: "Read other user's items",
      createItems: 'Create items',
      editOwnItems: 'Edit own items',
      editOtherItems: "Edit other user's items",
      editPlannedItems: 'Edit planned items',
      deleteOwnItems: 'Delete own items',
      deleteOtherItems: "Delete other user's items",
      createUsers: 'Create users',
      editUsers: 'Edit users',
      deleteUsers: 'Delete users',
      readOwnUserTime: 'Read own user time entry',
      readOtherUserTime: 'Read other user time entry',
      createUserTime: 'Create a user time entry',
      editOwnUserTime: 'Edit own user time entry',
      editOtherUserTime: "Edit another user's time entry",
      deleteOwnUserTime: 'Delete own user time entry',
      deleteOtherUserTime: "Delete another user's time entry",
