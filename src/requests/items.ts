...
export class BoughtItemsRequest {
  ...
  getItemsExcelTemplate() {
    return request.get(
      "/api/web/v1/items/bought/excel-template/",
  ...
  putItemsStatus(id: Number, status: string) {
    ...
    return request.put(
      `/api/web/v1/items/bought/${id}/status/`,
  ...
  putItemsGroup1(id: Number, group: any) {
    ...
    return request.put(
      `/api/web/v1/items/bought/${id}/group-1/`,
      requestConfig(params),
      null,
    );
  }
  ...
  putItemsQuantity(id: Number, quantity: any) {
    ...
    return request.put(
      `/api/web/v1/items/bought/${id}/quantity/`,
      requestConfig(params),
      null,
    );
  }
  putItemsPartnumber(id: Number, partnumber: any) {
    ...
    return request.put(
      `/api/web/v1/items/bought/${id}/partnumber/`,
      requestConfig(params),
      null,
    );
  }
  ...
  putItemsManufacturer(id: Number, manufacturer: any) {
    ...
    return request.put(
      `/api/web/v1/items/bought/${id}/manufacturer/`,
      requestConfig(params),
      null,
    );
  }
  putItemsSupplier(id: Number, supplier: any) {
    ...
    return request.put(
      `/api/web/v1/items/bought/${id}/supplier/`,
      requestConfig(params),
      null,
    );
  }
  putItemsNoteGeneral(id: Number, note: any) {
    ...
    return request.put(
      `/api/web/v1/items/bought/${id}/note-general/`,
      requestConfig(params),
      null,
    );
  }
  putItemsNoteSupplier(id: Number, note: any) {
    ...
    params.append("note", note);
    return request.put(
      `/api/web/v1/items/bought/${id}/note-supplier/`,
      requestConfig(params),
      null,
    );
  }
  putItemsDesiredDeliveryDate(id: Number, date: any) {
    ...
    return request.put(
      `/api/web/v1/items/bought/${id}/desired-delivery-date/`,
      requestConfig(params),
      null,
    );
  }
  putItemsExpectedDeliveryDate(id: Number, date: any) {
    ...
    params.append("date", date);
    return request.put(
      `/api/web/v1/items/bought/${id}/expected-delivery-date/`,
      requestConfig(params),
      null,
    );
  }
  putItemsStorage(id: Number, storage: any) {
    ...
    return request.put(
      `/api/web/v1/items/bought/${id}/storage/`,
      requestConfig(params),
      null,
    );
  }
