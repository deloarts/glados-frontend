...
export const useBoughtItemsControlsStore = defineStore('boughtItemsControls', () => {
  ...
  watch(
    state,
    () => {
      localStorage.setItem('gladosBoughtItemControlsState', JSON.stringify(state.value))
  ...
  watch(
    columns,
    () => {
      localStorage.setItem('gladosBoughtItemControlsColumns', JSON.stringify(columns.value))
...
export const useProjectsControlsStore = defineStore('projectsControls', () => {
  ...
  watch(
    state,
    () => {
      localStorage.setItem('gladosProjectControlsState', JSON.stringify(state.value))
  ...
  watch(
    columns,
    () => {
      localStorage.setItem('gladosProjectControlsColumns', JSON.stringify(state.value))
