...
watch(
  ...
  () => {
    localStorage.setItem(
      ...
      JSON.stringify(controlsStore.$state),
    );
    localStorage.setItem(
      "gladosBoughtItemDataTableFilter",
...
onBeforeMount(() => {
  ...
  if (controlsObject != null) {
    controlsStore.$state = JSON.parse(controlsObject);
  }
...
<template>
  <div class="views-scope">
    <div class="views-content">
      <div
        class="grid"
        v-bind:class="{ 'show-changelog': controlsStore.changelog }"
      >
